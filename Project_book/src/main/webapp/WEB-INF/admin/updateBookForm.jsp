		...
		<div class="row d-flex justify-content-center">
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="blog__details__form">
					...
					<form:form commandName="book" action="updateBook.ad" enctype="multipart/form-data">
						<input type="hidden" name="book_no" value="${book.book_no}">
						<input type="hidden" name="upload" value="${book.photo }">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								
								<form:errors cssClass="err" path="bname" />
								<input type="text" name="bname" value="${book.bname }" placeholder="책 이름을 입력하세요">
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								...
								<input type="text" name="author" value="${book.author }" placeholder="저자를 입력하세요">
							</div>
							
							<div class="col-lg-6 col-md-6 col-sm-6">
								<form:errors cssClass="err" path="publisher" />
								<input type="text" name="publisher" value="${book.publisher }" placeholder="출판사를 입력하세요">
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								<p>출판일</p>
								<input type="date" name="bookdate" value="${book.bookdate }" placeholder="출판일을 입력하세요">
